...
--
-- Name: elements un_name; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements un_sym; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT un_sym UNIQUE (symbol);


--
-- Name: properties fk_at_nbr; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_at_nbr FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
